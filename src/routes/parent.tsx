...
import { Menu, X, LayoutDashboard, GraduationCap, CheckSquare, FileText, Megaphone, FolderOpen, Star, Calendar, Wallet } from "lucide-react";
...
const navItems = [
  ...
  { to: "/parent/fee-portal", label: "Fee Portal" },
