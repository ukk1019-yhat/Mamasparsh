  ...
  head: () => ({
    meta: [
      ...
      { title: "MamaSparsh Preschool — A Mother's Touch for Every Little Dream" },
      {
        name: "description",
        content:
          "Welcome to the MamaSparsh Panda World — a premium, nurturing preschool where little pandas read, write, paint, dance and grow through nature-inspired, child-centric learning.",
      },
...
function ScrollProgress() {
  ...
  return (
    <motion.div
      className="fixed inset-x-0 top-0 z-[100] h-[3px] origin-left bg-gradient-to-r from-primary/60 via-accent to-primary/60"
